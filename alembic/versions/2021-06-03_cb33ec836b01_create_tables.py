...
Revision ID: cb33ec836b01
Revises:
Create Date: 2021-06-03 08:42:45.028265
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("entity_id", "organization_id"),
    )
    op.create_table(
        "entity_person",
        sa.Column("entity_id", sa.Integer(), nullable=False),
        ...
        sa.PrimaryKeyConstraint("entity_id", "person_id"),
    )
    op.create_table(
        "horse_shows",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["jockey_id"], ["entities.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["owner_id"], ["entities.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["race_id"], ["races.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["trainer_id"], ["entities.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
...
def downgrade():
    ...
    op.drop_table("entity_organization")
